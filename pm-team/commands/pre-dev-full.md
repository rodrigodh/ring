...
After getting the feature name (and auth/license requirements if applicable), create the directory structure and run the 10-gate workflow:
...
- All 10 gates provide maximum planning depth
