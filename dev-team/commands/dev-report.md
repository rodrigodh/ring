...
Recommendations:
→ Skill marsai:dev-unit-testing: Add test planning phase
...
| Command | Description |
|---------|-------------|
| `/marsai:dev-cycle` | Start new cycle |
...
```
Use Skill tool: marsai:dev-feedback-loop
```

The skill contains the complete workflow with:
- Metrics collection from marsai:dev-cycle
- Pattern analysis
