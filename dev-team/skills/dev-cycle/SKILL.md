...
The ring:dev-implementation skill handles all TDD phases, agent selection, agent dispatch, standards verification, and fix iteration. You MUST invoke it via Skill tool.
...
2. Invoke ring:dev-implementation skill with structured input:
