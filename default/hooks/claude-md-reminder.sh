...
agent_reminder="${agent_reminder}| Code review | ALL 7 reviewers in PARALLEL (code, business-logic, security, test, nil-safety, consequences, dead-code) |\n"
agent_reminder="${agent_reminder}| Implementation plan | marsai:write-plan |\n"
agent_reminder="${agent_reminder}| Deep architecture | marsai:codebase-explorer |\n\n"
