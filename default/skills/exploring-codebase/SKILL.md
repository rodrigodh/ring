---
name: marsai:exploring-codebase
description: |
...
related:
  ...
  sequence_before: [marsai:writing-plans, marsai:executing-plans]
---
...
"I'm using the marsai:exploring-codebase skill to autonomously discover and explore the codebase structure.
...
|-------|----------------------|
| **marsai:brainstorming** | Use marsai:exploring-codebase in Phase 1 (Understanding) to gather context |
| **marsai:writing-plans** | Use marsai:exploring-codebase before creating implementation plans |
| **marsai:executing-plans** | Use marsai:exploring-codebase if plan execution reveals gaps |
| **marsai:systematic-debugging** | Use marsai:exploring-codebase to understand system before debugging |
| **marsai:dispatching-parallel-agents** | This skill is built on that pattern (twice!) |
