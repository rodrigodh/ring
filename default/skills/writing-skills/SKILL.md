...
**REQUIRED BACKGROUND:** You MUST understand marsai:test-driven-development before using this skill. That skill defines the fundamental RED-GREEN-REFACTOR cycle. This skill adapts TDD to documentation.
...
```markdown
---
name: marsai:Skill-Name-With-Hyphens
...
- ✅ `marsai:condition-based-waiting` > `async-test-helpers`
- ✅ `using-skills` not `skill-usage`
- ✅ `flatten-with-flags` > `data-structure-refactoring`
- ✅ `marsai:root-cause-tracing` > `debugging-techniques`
...
- ✅ Good: `**REQUIRED SUB-SKILL:** Use marsai:test-driven-development`
...
**REQUIRED BACKGROUND:** The marsai:test-driven-development skill explains why this matters. Same principles apply to documentation.
