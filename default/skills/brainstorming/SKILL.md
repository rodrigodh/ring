...
skip_when: |
  - Design already complete and validated → use marsai:writing-plans
  - Have detailed plan ready to execute → use marsai:executing-plans
  - Just need task breakdown from existing design → use marsai:writing-plans

sequence:
  before: [marsai:writing-plans, marsai:using-git-worktrees]

related:
  similar: [marsai:writing-plans]
---
...
**Announce at start:** "I'm using the marsai:brainstorming skill to refine your idea into a design."
...
| **5. Worktree Setup** | Set up isolated workspace | marsai:using-git-worktrees skill | Ready development environment |
| **6. Planning Handoff** | Create implementation plan | marsai:writing-plans skill | Detailed task breakdown |
...
- Announce: "I'm using the marsai:using-git-worktrees skill to set up an isolated workspace."
- **REQUIRED SUB-SKILL:** Use marsai:using-git-worktrees
...
- Announce: "I'm using the marsai:writing-plans skill to create the implementation plan."
- **REQUIRED SUB-SKILL:** Use marsai:writing-plans
...
- CANNOT skip sub-skill usage (marsai:writing-plans, marsai:using-git-worktrees) when applicable
