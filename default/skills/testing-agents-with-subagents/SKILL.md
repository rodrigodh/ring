---
name: marsai:testing-agents-with-subagents
description: |
...
related:
  complementary: [marsai:test-driven-development]
---
...
**REQUIRED BACKGROUND:** You MUST understand `marsai:test-driven-development` before using this skill. That skill defines the fundamental RED-GREEN-REFACTOR cycle. This skill provides agent-specific test formats (test inputs, output verification, accuracy metrics).
