...
trigger: |
  - User invokes /marsai:interview-me command
...
sequence:
  before: [brainstorming, marsai:writing-plans]
  after: []
...
**Announce at start:** "I'm using the marsai:interviewing-user skill to gather requirements before we begin."
...
| Skill | Relationship |
|-------|--------------|
| `marsai:doubt-triggered-questions` | Use for single questions during work; use marsai:interviewing-user for systematic upfront gathering |
| `marsai:brainstorming` | Interview first to gather requirements, THEN brainstorm solutions |
| `marsai:writing-plans` | Interview first to clarify scope, THEN create plan |
